...
//            paperC.push_back(approxHullBest[1]);
//            paperC.push_back(approxHullBest[4]);
//            paperC.push_back(approxHullBest[0]);
//            paperC.push_back(approxHullBest[5]);
...
Java_com_tryfitCamera_camera_PaperDetectionActivity_processSimplePictureAndroid(JNIEnv *env,
                                                                                jclass type,
                                                                                jlong inputMatAddr) {
