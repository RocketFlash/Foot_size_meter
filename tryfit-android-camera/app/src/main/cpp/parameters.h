...
extern int bestMethod;
extern int bestThresholdAdaptive;
extern int bestThresholdSimple;
extern int bestBlockSize;
extern int bestThresh;
extern int bestChannel;
extern int bestBlurredKernelSize;
extern int bestEps;
extern int bestAperture;
extern int numberOfContoursToCheck;
extern vector<Point> bestA4Contour;
extern String colors[];
extern String methods[];
extern vector<double> slices;
