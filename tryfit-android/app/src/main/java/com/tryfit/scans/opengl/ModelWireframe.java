...
public class ModelWireframe {
    ...
    public void init(ModelBuffersWireframe modelBuffers, String vertexShader, String fragmentShader) {
...
//        bindBuffers(modelBuffers);
    ...
    public void bindBuffers(ModelBuffersWireframe modelBuffers) {
...
//
//        GLES20.glUniform4f(mColorHandle, 0.9f, 0.9f, 0.9f, 1.0f);
...
//        GLES20.glUniform1f(mPointSizeHandle, 100.0f);
        GLES20.glDrawElements(GLES20.GL_LINES, indicesCount, GLES20.GL_UNSIGNED_INT, 0);
