...
public class ModelBuffers {
    ...
    public void init(Mesh mesh) {
        ...
        bufferIndices = ByteBuffer.allocateDirect(indicesLength).order(ByteOrder.nativeOrder()).asIntBuffer();
        bufferIndices.put(ByteBuffer.wrap(mesh.getVboData(), mesh.getIndicesOffset(), indicesLength)
                .order(ByteOrder.nativeOrder())
                .asIntBuffer())
                .position(0);
